...
export const WAYPOINTS = [
  ...
  { id: "overlook", name: "The Overlook", x: -134.86, y: -14.17, radius: 37.0,
    note: "top of stairs / loop entry, confirmed via OSM connector + uphill screenshot" },
  { id: "northrim", name: "North Rim", x: -258.91, y: -139.56, radius: 69.6,
    note: "max-latitude point on the real loop (data-derived)" },
